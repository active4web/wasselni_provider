                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        RaisedButton(color: Colors.blue[900],
                                            onPressed:   () {
                                              _allNetworking
                                                  .update_order(
                                                  token_id: token,
                                  ...
                                  GestureDetector(onTap: ()async{
                                    // Get.to(MapForOlder(lat:double.parse(snapshot.data.result
                                    //     .allOrders[pos].lat) ,lag: double.parse(snapshot.data.result
                                    //     .allOrders[pos].lag),));
                                    final availableMaps =
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        //       left: 16, right: 16),
                                        //   child: Text(snapshot.data.result
                                        //       .allOrders[pos].lag+" "+snapshot.data.result
                                        //       .allOrders[pos].lat),
                                        // ),
                                      ],
                                    ),
