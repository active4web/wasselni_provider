        ...
        body: SafeArea(
          ...
          child: ListView(
            ...
            children: [
             ...
             StreamBuilder(stream: v.validationUserDatamy,builder: (context,data){
               return   GestureDetector(onTap: data.data!=null?(){
                 ...
                 child: Container(
                   ...
                   decoration:data.data!=null? BoxDecoration(
                       color: hexToColor('#00abeb'), gradient: new LinearGradient(
